...
import (
	...
	"github.com/chik-network/chik-exporter/internal/metrics"
)
...
var serveCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		// Run this in the background, so the metrics healthz endpoint can come up while waiting for Chik
		go startWebsocket(m)
...
func startWebsocket(m *metrics.Metrics) {
	...
	// This enables starting the metrics exporter even if the chik RPC service is not up/responding
